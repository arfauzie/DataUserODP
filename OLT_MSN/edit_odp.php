...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $update_stmt = $pdo->prepare("UPDATE odp1 SET nama_odp=?, pon_id=?, port_max=?, latitude=?, longitude=? WHERE id=?");
        ...
        <div class="card-box">
            ...
            <form method="POST">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="olt_msn.php?pon_id=<?= $odp['pon_id']; ?>" class="btn btn-secondary">Kembali</a>
                </div>
            </form>
        </div>
    </div>
