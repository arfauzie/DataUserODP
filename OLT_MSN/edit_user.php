...
require_once 'config.php'; // pastikan $pdo sudah dibuat di sini (ERRMODE_EXCEPTION, dsb)
        ...
        <div class="card-box">
            ...
            <form method="POST">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="olt_msn.php?pon_id=<?= (int)$pon_id ?>&odp_id=<?= (int)$odp_id ?>" class="btn btn-secondary">Kembali</a>
                </div>
            </form>
        </div>
    </div>
