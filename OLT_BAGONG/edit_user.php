...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($nama_user && $nomor_internet && $alamat) {
        $stmt = $pdo2->prepare("UPDATE users2 SET nama_user = ?, nomor_internet = ?, alamat = ? WHERE id = ?");
        ...
        <div class="card-box">
            ...
            <form method="POST">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="olt_bagong.php?pon_id=<?= $pon_id ?>&odp_id=<?= $odp_id ?>" class="btn btn-secondary">Kembali</a>
                </div>
            </form>
        </div>
    </div>
