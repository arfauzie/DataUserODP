...
$riwayat = getRiwayatSoreang($pdo3); // gunakan fungsi khusus OLT Soreang
?>
...
<head>
    <meta charset="UTF-8">
    <title>Riwayat OLT SOREANG</title>
...
<body>
    <div class="content-wrapper">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <form id="hapusSemuaForm" method="post" action="delete3_log.php" style="margin:0;">
